...
const respuesta_rodamiento = (respuesta, rodamiento) => {
  campo_respuesta.html(`<p>${rodamiento.modelo} Rodamientos Comprados Desde China: ${rodamiento.comprado}
    ${respuesta} ${rodamiento.modelo} Vendidos: ${rodamiento.vendido}</p>`);
