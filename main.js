...
//Imagenes de la portada del menu
var foto_portada_superior = $("#rodamientos_portada");
var foto_portada_inferior = $("#rodamientos_portada_inferior");
var foto_menu_disponible = $("#rodamientos_consultar");
...
boton.on("click", function(event) {
  ...
  campo_respuesta.css("font-size", "100px");
...
consultar_disponibilidad.on("click", function(event) {
  ...
  boton_historial_ventas.css("width", "600px");
...
boton_regresar.on("click", function() {
  ...
  boton_historial_ventas.show();
  foto_portada_superior.show();
  foto_portada_inferior.show();
...
boton_calcular_rodamientos.on("click", function() {
  ...
  if (rodamiento_solicitado == 6201) {
    ...
    campo_respuesta.css("width", "900px");
    campo_respuesta.css("height", "340px");
    campo_respuesta.css("font-size", "90px");
    campo_respuesta.css("padding-top", "0px");
    campo_respuesta.html(`<p>Por Favor Introduzca Un Rodamiento, y Solo Seleccione Uno</p>`);
  }
